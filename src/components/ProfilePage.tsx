...
import { Phone, MapPin, Mail, Shield, Edit2, Save, X, LogOut, Loader2, User as UserIcon, Lock } from 'lucide-react';
...
export default function ProfilePage() {
  ...
  // Added name to the edit form state
  ...
  const handleUpdateProfile = async (e: React.FormEvent) => {
    ...
    setSaving(true);
    try {
      // Ensure your useFirestore hook supports updating the 'name' field
          ...
          <div className="p-8">
            <form onSubmit={handleUpdateProfile} className="space-y-6">
              <div className="grid gap-4">
                ...
                {/* Email (Read-only) */}
                <div className="flex items-start space-x-4 p-4 rounded-2xl bg-brand-cream/30 border border-brand-navy/5 opacity-70">
                  <div className="mt-1 p-2 bg-brand-navy/5 rounded-xl">
                ...
                {/* Password Section */}
                <div className="flex items-center justify-between p-4 rounded-2xl bg-brand-cream/30 border border-brand-navy/5">
                  <div className="flex items-center space-x-4">
                    <div className="p-2 bg-brand-navy/5 rounded-xl">
                      <Lock className="h-5 w-5 text-brand-navy" />
                    </div>
                    <div>
                      <label className="text-[10px] font-black uppercase tracking-widest text-brand-navy/40">Security</label>
